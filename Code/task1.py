...
def driver():
    feature_option = int(input("Please pick one of the below options\n"
                               ...
                               "5. Resnet FC\n"
                               "6. All\n"))
    if feature_option not in list(range(1, 7)):
        print(f"Invalid input: {feature_option}")
        driver()
    image_id = int(input("Enter image ID for extracting features.\n"))
    while image_id not in list(range(8677)):
        print(f"Invalid image ID: {image_id}. Please pick image ID in range of 0-8676.")
        image_id = int(input("Enter image ID for extracting features.\n"))
    extract_features_and_visualize_image(image_id, feature_option)
